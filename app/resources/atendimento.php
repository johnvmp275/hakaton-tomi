...
<form class="container" method="POST">
    ...
    <div class="form-double">
        <div class="form-group">
            ...
            <input required class="form-control" type="date" name="data_atendimento" placeholder="Digite a Data do Atendimento">
        </div>
    </div>
    ...
    <div class="form-double">
        <div class="form-group">
            ...
            <input required class="form-control" type="number" name="altura" step="0.01" placeholder="Digite a Altura (m)">
        </div>

        <div class="form-group">
            <span class="">Insira o Peso:</span>
            <input required class="form-control" type="number" name="peso" step="0.01" placeholder="Digite o Peso (kg)">
        </div>
    </div>
